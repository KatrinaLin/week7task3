...
public class EmployeeJPATest {
    ...
    public void should_return_employee_given_character_in_name_and_salary_large_than() throws Exception {
        ...
        String actualName = employeeRepository.findFirstByNameContainingAndSalaryGreaterThan('g', 6500).getName();
    ...
    public void should_return_employee_list_when_input_page_request() throws Exception {
        ...
        Page<Employee> EmployeePage = employeeRepository.showTwoEmployeesPerPage();
    ...
    public void should_return_company_name_when_input_employee_name() throws Exception {
        ...
        String actualCompanyName = employeeRepository.getEmployeeCompanyName("xiaohong");
    ...
    public void should_return_influence_lines_when_update_employee_name() throws Exception {
        ...
        Integer actualLine = employeeRepository.countEffectedRowFromUpdatingName("xiaohong", "xiaobai");
    ...
    public void should_deleted_employee_when_given_employee_name() throws Exception {
        ...
        String targetName = "xiaohong";

        employeeRepository.deleteByName(targetName);

        Employee actualEmployee = employeeRepository.findByName(targetName);
